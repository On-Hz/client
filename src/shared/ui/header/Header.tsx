    ...
    <header className="border-b border-gray3">
      <div className="flex items-center justify-between px-[20px] py-[38px]">
        ...
        <nav className="flex items-center">
          ...
          <button
            className="text-black py-[10px] px-[12px] mr-[5px] transform hover:text-point transition-colors"
            onClick={() => openAuthModal("login")}
          >
            로그인
          </button>
          <button
            className="bg-black text-white border rounded-[5px] py-[10px] px-[12px] transform hover:bg-point transition-colors"
