    ...
    return (
        <div className='w-[700px] hz-left'>
            <div className='flex items-end'>
                {/* 앨범 커버 */}
                <div className='hz-cover flex items-center justify-center rounded-[10px] w-[240px] h-[240px] overflow-hidden'>
                    <Skeleton variant="rectangular" width="100%" height="100%" />
                </div>
                 {/* 앨범, 아티스트 정보 */}
                <div className='pl-[18px] hz-ab-info'>
                    <div className='flex items-center'>
                        <span className='w-[50px] h-[50px] rounded-[50%] overflow-hidden'>
